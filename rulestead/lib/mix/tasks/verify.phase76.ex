...
defmodule Mix.Tasks.Verify.Phase76 do
  ...
  @shortdoc "Runs Phase 78 v1.11 integration-spine verification suite"

  # Flat union of verify.phase73 core (v1.10.1 post-GA superset) + v1.11 intro spine guards.
  # Do not delegate to verify.phase73 or other sub-tasks (avoids duplicate runs).
  @phase76_core_tests [
  ...
  @impl Mix.Task
  def run(_args) do
    Mix.Task.run("test", @phase76_core_tests)
