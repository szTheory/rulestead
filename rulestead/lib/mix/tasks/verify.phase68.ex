...
defmodule Mix.Tasks.Verify.Phase68 do
  @moduledoc false
  ...
  # Union of verify.phase64 core + v1.9 preview-evidence delta — do not call verify.phase64,
  # verify.phase60, or other sub-tasks (avoids duplicate runs).
  @phase68_core_tests [
  ...
  @impl Mix.Task
  def run(_args) do
    Mix.Task.run("test", @phase68_core_tests)
