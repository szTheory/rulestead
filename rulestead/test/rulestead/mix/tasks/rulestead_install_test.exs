defmodule Rulestead.Mix.Tasks.RulesteadInstallTest do
  ...
  test "mix task writes deterministic host wiring and reruns idempotently", %{tmp_dir: tmp_dir} do
    ...
    assert output_lines(first_output) == [
             ...
             "copy priv/repo/migrations/20260516193701_create_rulestead_code_references.exs",
             "copy priv/repo/migrations/20260516212817_create_analytics_events.exs",
             "copy priv/repo/migrations/20260518193000_create_rulestead_environment_versions.exs",
             "copy priv/repo/migrations/20260518234600_extend_rulestead_change_request_actions_for_promotion.exs",
             "copy priv/repo/migrations/20260518234700_extend_rulestead_scheduled_execution_actions_for_promotion.exs",
