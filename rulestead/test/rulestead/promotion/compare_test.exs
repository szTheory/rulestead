defmodule Rulestead.Promotion.CompareTest do
  ...
  defmodule CompareStoreStub do
    ...
    def list_audience_dependencies(_), do: missing()
    def preview_audience_impact(_), do: missing()
    def apply_audience_mutation(_), do: missing()
    def record_evaluation(_), do: missing()
    def advance_rollout(_), do: missing()
    def evaluate_guarded_rollout(_), do: missing()
    def upsert_rollout_auto_advance_policy(_), do: missing()
    def fetch_rollout_auto_advance_policy(_), do: missing()
    def evaluate_rollout_auto_advance(_), do: missing()
    def fetch_guardrail_status(_), do: missing()
