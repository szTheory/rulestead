...
#
#     PHX_SERVER=true bin/rulestead_demo start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :rulestead_demo, RulesteadDemoWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :rulestead_demo, RulesteadDemo.Repo,
    # ssl: true,
    url: database_url,
  ...
  redis_url = System.get_env("RULESTEAD_REDIS_URL")

  if redis_url do
    config :rulestead, :redis,
      enabled: true,
      url: redis_url
