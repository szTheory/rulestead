defmodule RulesteadDemo.DataCase do
  @moduledoc """
  ...
  by setting `use RulesteadDemo.DataCase, async: true`, although
  ...
  using do
    quote do
      alias RulesteadDemo.Repo

      import Ecto
      import Ecto.Changeset
      import Ecto.Query
      import RulesteadDemo.DataCase
    end
  end
  ...
  def setup_sandbox(tags) do
    ...
    on_exit(fn ->
      ...
      Ecto.Adapters.SQL.Sandbox.stop_owner(rulestead_owner)
    end)
  end
