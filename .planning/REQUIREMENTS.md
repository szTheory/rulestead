...
- [ ] **AUD-03**: Successful auto-advance records auditable evidence with guardrail facts, observation window, triggering source `guardrail_automation`, and stage transition context in the existing audit envelope.
