...
- [x] 114-01-PLAN.md - Demo-host Phoenix matrix route, deterministic fixtures, and ExUnit smoke/source assertions.
...
- [x] 117-02-PLAN.md — Route-level Playwright evidence for route flow, keyboard, focus, mobile, and screenshots.

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 117-03-PLAN.md — Route-owned IA fixes for home, inventory, audience, rules, and kill-switch flows.

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 117-04-PLAN.md — Audit/explain/simulate evidence-triggered fixes and final FLOW handoff.
...
- [x] 118-01-PLAN.md - Durable design-system evidence source guard and lint wiring.
...
- [x] 118-03-PLAN.md - Requirement, roadmap, state, and validation closeout after evidence exists.
...
| 118. Evidence + Idempotence Guardrails | 3/3 | Complete    | 2026-06-14 |
