...
| 117-03-02 | 03 | 2 | FLOW-02/FLOW-03 | T-117-06 | Rules and kill-switch route-owned IA fixes preserve draft/publish state, emergency sequencing, server-side authorization, and audit handoff semantics | route/browser | `cd rulestead_admin && mix test test/rulestead_admin/live/flag_live/rules_test.exs test/rulestead_admin/live/flag_live/kill_test.exs test/rulestead_admin/live/flag_live/accessibility_test.exs && cd ../examples/demo/frontend && DEMO_BACKEND_URL=<backend-url> npm run test:e2e -- admin-flow-ia.spec.ts` | after W0 | pending |
| 117-04-01 | 04 | 3 | FLOW-02/FLOW-03 | T-117-07 | Audit, explain, and simulate fixes stay issue-triggered and preserve URL state, redaction, raw-detail disclosure, support-safe copy, and route-owned semantics | route/browser | `cd rulestead_admin && mix test test/rulestead_admin/live/audit_live/index_test.exs test/rulestead_admin/live/flag_live/explain_test.exs test/rulestead_admin/live/flag_live/simulate_test.exs test/rulestead_admin/live/flag_live/simulate_accessibility_test.exs && cd ../examples/demo/frontend && DEMO_BACKEND_URL=<backend-url> npm run test:e2e -- admin-flow-ia.spec.ts` | after W0 | pending |
| 117-04-02 | 04 | 3 | FLOW-01/FLOW-02/FLOW-03/FLOW-04 | T-117-08 | Final review artifact maps every requirement, D-01 through D-18, Phase 118 handoff, and proof command without adding forbidden tooling or package/release changes | source/browser | `rg -n "FLOW-01|FLOW-02|FLOW-03|FLOW-04|D-01|D-18|Phase 118 Handoff|admin-flow-ia.spec.ts|overview|inventory|rules|kill|audience|audit|explain|simulate" .planning/phases/117-page-flow-ia-pass/117-FLOW-IA-REVIEW.md && cd examples/demo/frontend && DEMO_BACKEND_URL=<backend-url> npm run test:e2e -- admin-flow-ia.spec.ts` | after W0 | pending |
