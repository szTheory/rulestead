...
- **System mode** (default): the CSS `@media (prefers-color-scheme: dark)` rule fires at first
...
Pass it when you want the admin to default to a specific theme for all users who have not yet
made a manual selection:
