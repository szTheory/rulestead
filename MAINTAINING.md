...
Use this table to diagnose a failing CI lane and choose the right rerun. Rows are in `release_gate` pipeline order. Each rerun command targets the lane exactly — do not substitute a broader test command.
