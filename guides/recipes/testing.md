...
| FleetDesk adoption lab | Full stack + admin + browser glue | [Adoption Lab](../introduction/adoption-lab.md#at-a-glance) · `scripts/demo/proof.sh` or `scripts/demo/verify.sh` |
